...
<View style ={styles.container}>
    <View>
      <Text style = {{fontWeight:"bold",fontSize:25,padding:20,fontFamily:'HelveticaNeue-Italic',color:'#3bde26', alignSelf:"stretch"}}style = {{fontWeight:"bold",fontSize:28,padding:20,fontFamily:'HelveticaNeue-Italic',color:'#3bde26', alignSelf:"stretch"}}>Community Search</Text>
      ...
      >
        <Text style = {{fontSize:10,textAlign:"center",paddingTop:5}}>?</Text>
        </TouchableOpacity> 
        </View>     
    </View>
    ...
    <View style = {{padding:10,
                    ...
                    marginRight:15,
                    marginTop :20}}>
    <ModalDropdown options = {this.state.InterationGroup}
                                defaultValue = "Interaction Group" textStyle= {{fontSize:20}} 
                                dropdownStyle ={{width:170}} 
                                dropdownTextStyle = {{fontSize:14}} 
                                onSelect = {(value) => this.setState({asData: (String(this.state.InterationGroup[value]))})}
                                 />
    </View>
   </View>
